...
static void normaliza(float *linha, int largura, int fluxoDesejado) { /* Normaliza a linha para ter o fluxo desejado */
    int i = 0;
    float fluxoObtido = 0;
...
static float velocidadeAleatoriaDaAgua (int posicaoNaLinha, int margemDireita, int margemEsquerda, int largura, float limiteDasMargens) {
...
static int tamanhoDaPrimeiraMargem(int largura, float limiteDasMargens) { /* Calcula um valor aleatório para o tamanho das margens da primeira linha */
...
static int insereIlha(float *linha, int distanciaMinimaEntreIlhas, float probIlha, int tmargemEsquerda, int tmargemDireita, int largura){
    int q, i;
    int sorteio;
...
static int margemEsquerda (float *linha) { /* Retorna o tamanho da margem esquerda da linha */
    int n = 0;
...
static int margemDireita (float *linha, int largura) { /* Retorna o tamanho da margem direita da linha de tamanho 'largura' */
    int n = largura-1;
...
static void aleatorizaMargem(float *linhaAnterior, float *linha, float limiteDasMargens, int largura){ /* Calcula o novo tamanho das margens, baseado
                                                                                                 na linha anterior */
